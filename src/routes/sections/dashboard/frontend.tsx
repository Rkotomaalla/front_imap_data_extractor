...
export function getFrontendDashboardRoutes(): RouteObject[] {
	const frontendDashboardRoutes: RouteObject[] = [
		{ path: "work", element: Component("/pages/dashboard/work") },
			...
			children: [
				...
				},
				{
					...
					children: [
						...
						{ path: "new", element: Component("/pages/management/bot/new") },
						{ path: "list", element: Component("/pages/management/bot/list") },
						{ path: "detail/:id", element: Component("/pages/management/bot/detail") },
						{ path: "update/:id", element: Component("/pages/management/bot/update") },
					],
				},
				{
					path: "mail",
					children: [
						...
						{ path: "activity", element: Component("/pages/management/mail/activity") },
					],
				},
				{
					path: "system",
